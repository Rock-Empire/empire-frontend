...
function MeetTeam() {
  return (
    <React.Fragment>
      <div className='text-center mt-[3rem] h-[680px] m-auto sm-sc:w-[350px] sm-sc:h-[1200px] sm-sc:mt-[35rem] mini-sc:w-[900px] mini-sc:h-[1000px] mini-sc:mt-[22rem] lg-sc:w-[1200px] mini-sc:mt-[4rem]'>

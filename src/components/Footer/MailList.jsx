...
function MailList() {
  ...
  return (
    <React.Fragment>
      <div
        className='flex flex-col text-center w-full h-[40vh] bg-no-repeat font-normal bg-cover text-center text-[#ffffff] flex justify-center items-center mt-[3rem] xs:w-[300px]'
        style={myStyle}
      >

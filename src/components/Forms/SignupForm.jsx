      ...
      <form className=''>
        <div className='flex gap-6'>
          <div className='w-[50%] mb-[1rem]'>
            <label htmlFor='firstName'>
              First Name <span className='text-[#ED3833]'>*</span>
            </label>
            <input
              className='w-[100%] border rounded-md text-[#D1D1D1] p-[0.5rem]'
              type='text'
            />
          </div>
          <div className='w-[50%] mb-[1rem]'>
            <label htmlFor='lastName'>
              Last Name <span className='text-[#ED3833]'>*</span>
            </label>
            <input
              className='w-[100%] border rounded-md text-[#D1D1D1] p-[0.5rem]'
              type='text'
        ...
        <div className='mb-[1rem]'>
          <label htmlFor='phoneNumber'>
            Phone Number <span className='text-[#ED3833]'>*</span>
          </label>
          <input
            className='w-[100%] border rounded-md text-[#D1D1D1] p-[0.5rem]'
            type='tel'
        ...
        <div className='mb-[1rem]'>
          ...
          />
          <FaEye
            className='absolute bottom-[10rem] right-[10rem] mini-sc:right-[2rem] sm-sc:bottom-[0rem] sm-sc:right-[5rem]'
            onClick={toggleBtn}
          ></FaEye>
        </div>

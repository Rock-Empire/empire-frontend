...
function PlayRaffleHero() {
  return (
    <div
      className='bg-no-repeat bg-black font-normal flex flex-col bg-cover text-center text-[#ffffff] items-center'
      style={{
    ...
    >
      <div className='w-[1000px] m-auto flex items-center flex-col sm-sc:w-[300px]'>
        ...
        {Data.map((data, i) => (
          <li className='text-xl sm-sc:text-[16px] bg-[#E7E9EB] text-[#000000] p-[10px] w-[95px] h-[73px]' key={i}>
            {data.days}
            <br />
            {data.word}
          </li>

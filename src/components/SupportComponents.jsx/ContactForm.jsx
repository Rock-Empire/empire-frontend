...
function ContactForm() {
  return (
    <div className='w-[700px] h-[700px] sm-sc:w-[350px] sm-sc:h-[400px]'>
      <div className=''>
        <h1 className='font-bold text-[34px] pb-[2rem] sm-sc:text-[24px]'>Get in touch with us</h1>
        <Formik
          initialValues={{
            email: "",
            phoneNumber: "",
        ...
        >
          {({
            ...
            <form className='flex flex-col' onSubmit={handleSubmit}>
              ...
              <button className='bg-treColor1 w-[20%] p-[1rem] text-[#ffffff] rounded-md text-[16px] mt-[3rem]sm-sc:w-[30%]' style={{rows: "10",cols: "50"}} type='submit' disabled={isSubmitting}>
               Submit
              </button>
            </form>
          )}
